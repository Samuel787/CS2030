...
public class Shop{
    ...
    public Shop(/*int[] custIDs, int[] custType, double[] custReArrivalTime, double[] custArrivalTime,*/ ArrayList<ICustomer> customers,  int numArrival, int servMaxCust, int numServer, int servQueueSize){
