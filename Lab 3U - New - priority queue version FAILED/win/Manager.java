...
public class Manager{
    ...
    private PriorityQueue<IEvent> events2;
    ...
    public Manager(ArrayList<IEvent> events, ArrayList<IServer> servers, ArrayList<ICustomer> customers){
        ...
        //tranfer all the events into priority queue
        events2 = new PriorityQueue<>();
        for(IEvent i: events){
            this.events2.add(i);
        }
    ...
    public String start(){
        ...
        */
        ...
        while(!events2.isEmpty()){
            //retrieve the earliest event
            IEvent event = events2.poll();
            ArrayList<IEvent> nextEvents = event.getNextEvent();
            for(IEvent i : nextEvents){
                if(i != null){
                    events2.add(i);
                }
            }
