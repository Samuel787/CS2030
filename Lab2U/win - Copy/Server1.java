public class Server1{
	...
	private int numCustomerServing = 0;
	...
	public boolean getServerBusy() {
		if(numCustomerServing >= numCustomerPerTime){
			return true;
		}
		return false;
	...
	public void addPeopleServing(){
		this.numCustomerServing++;
	}
	public void reducePeopleServing(){
		this.numCustomerServing--;
	}
