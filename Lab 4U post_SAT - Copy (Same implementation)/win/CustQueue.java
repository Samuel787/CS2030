    ...
    private void sortCustQueue(){
        ...
        Collections.sort(customers, (cust1, cust2) -> {
            ...
            */
            ...
            if(cust1 instanceof GeneralCustomer && cust2 instanceof GeneralCustomer){
                if(cust1.getArrivalTime() < cust2.getArrivalTime()){
                    return -1;
                } else if (cust1.getArrivalTime() == cust2.getArrivalTime()){
                    return 0;
                ...
                return 1;
            } else if(cust1 instanceof ElderlyCustomer && cust2 instanceof GeneralCustomer){
                return -1;
            } else {
                //Both elderly by cs1231
                if(cust1.getArrivalTime() < cust2.getArrivalTime()){
                    return -1;
                } else if (cust1.getArrivalTime() == cust2.getArrivalTime()){
                    return 0;
